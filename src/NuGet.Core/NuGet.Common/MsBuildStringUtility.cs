...
namespace NuGet.Common
{
    public static class MSBuildStringUtility
    {
        ...
        /// </summary>
        public static IEnumerable<NuGetLogCode> GetDistinctNuGetLogCodesOrDefault(IEnumerable<IEnumerable<NuGetLogCode>> nugetLogCodes)
        {
            if (nugetLogCodes.Count() > 0)
            {
                ...
                foreach (var logCodeList in nugetLogCodes)
                {
